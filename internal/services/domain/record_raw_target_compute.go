...
const (
	FingerprintAlgorithmRSA     = "RSA"
	FingerprintAlgorithmDSA     = "DSA"
	FingerprintAlgorithmECDSA   = "ECDSA"
	FingerprintAlgorithmEd25519 = "Ed25519"

	FingerprintTypeSHA1   = "SHA-1"
	FingerprintTypeSHA256 = "SHA-256"
)

var (
	FingerprintAlgorithmCorrespondance = map[string]uint8{
		FingerprintAlgorithmRSA:     1,
		FingerprintAlgorithmDSA:     2,
		FingerprintAlgorithmECDSA:   3,
		FingerprintAlgorithmEd25519: 4,
	}

	FingerprintTypeCorrespondance = map[string]uint8{
		FingerprintTypeSHA1:   1,
		FingerprintTypeSHA256: 2,
	}
)
...
func (model *RecordModel) ComputeRawTarget() string {
	...
	case domain.RecordSSHFP:
		record = &dns.SSHFP{
			Algorithm:   FingerprintAlgorithmCorrespondance[model.FingerprintAlgorithm.ValueString()],
			Type:        FingerprintTypeCorrespondance[model.FingerprintType.ValueString()],
