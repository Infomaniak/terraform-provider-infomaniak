...
type Api interface {
	...
	GetConfiguration(publicCloudId int64, publicCloudProjectId int64, dbaasId int64) (*MySqlConfig, error)
	// TODO MySqlConfig will need an interface later when we will support multiple db engines
	PutConfiguration(publicCloudId int64, publicCloudProjectId int64, dbaasId int64, configuration MySqlConfig) (bool, error)
