...
type Api interface {
	...
	PatchIPFilters(cidrs []string, publicCloudId int64, projectId int64, kaasId int64) (bool, error)
	GetIPFilters(publicCloudId int64, projectId int64, kaasId int64) ([]string, error)
}
